...
params['ModelParams']['snapshot']=10500
params['ModelParams']['dirTrain']=os.path.join(basePath,'PromiseNormalisedOrig/Train')
...
params['ModelParams']['dirSnapshots']=os.path.join(basePath,'Models/MRI_cinque_origDset/') #where to save the models while training
