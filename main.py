...
params['ModelParams']['dirTrain']=os.path.join(cwd,'/media/nas/01_Datasets/CT/Abdomen/3Dircadb1/niftis_segmented_tumorsonly')
params['ModelParams']['dirTest']=os.path.join(cwd,'/media/nas/01_Datasets/CT/Abdomen/3Dircadb1/niftis_segmented_tumorsonly')
